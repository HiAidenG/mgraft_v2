...
def main(snakemake):
    ...
    try:
        run_diamond(
            ...
            min_query_cov=snakemake.params.min_query_coverage,
            min_subject_cov=snakemake.params.min_subject_coverage,
        ...
        # Write final output
        results_df.to_csv(snakemake.output.virulence_genes_tsv, sep='\t', index=False, na_rep='NULL')
